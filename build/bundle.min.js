...
/***/ function(module, exports, __webpack_require__) {
	...
	var buildGui = function buildGui() {
	  ...
	  addGui('light intensity', light.intensity, function (val) {
	    light.intensity = val;
	    threeRender();
	  }, false, 0, 5);
	
	  addGui('light distance', light.distance, function (val) {
	    light.distance = val;
	    threeRender();
	  }, false, 100, 500);
	
	  addGui('light penumbra', light.penumbra, function (val) {
	    light.penumbra = val;
	    threeRender();
	  }, false, 0, 1);
	
	  addGui('light decay', light.decay, function (val) {
	    light.decay = val;
	    threeRender();
	  }, false, 0, 10);
	
	  addGui('light x', light.position.x, function (val) {
	    light.position.x = val;
	    threeRender();
	  }, false, -80, 80);
	
	  addGui('light y', light.position.y, function (val) {
	    light.position.y = val;
	    threeRender();
	  }, false, -80, 80);
	
	  addGui('light z', light.position.z, function (val) {
	    light.position.z = val;
	    threeRender();
	  }, false, -80, 80);
	};
	
	var addGui = function addGui(name, value, callback, isColor, min, max) {
	  var node = void 0;
	  param[name] = value;
