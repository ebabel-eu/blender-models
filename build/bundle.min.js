...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webglSupport = __webpack_require__(175);
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.light = new THREE.SpotLight(C.LIGHT_COLOR, C.LIGHT_INTENSITY);
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      (0, _webglSupport.WebglSupport)();
	
	      (0, _init.Init)(this.scene, this.renderer, this.camera, this.controls, this.light, this.stats);
	
	      (0, _loadModels.LoadModels)(this.scene);
	
	      this.animate();
	
	      (0, _gui.Gui)(this.scene, this.light);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { id: 'container', className: 'disable-select' },
...
/***/ function(module, exports) {
	...
	// Chess models.
	var CHESSBOARD_COLOR = exports.CHESSBOARD_COLOR = COLORS.BROWN;
	var WHITE_PIECE_COLOR = exports.WHITE_PIECE_COLOR = COLORS.BEIGE;
	var BLACK_PIECE_COLOR = exports.BLACK_PIECE_COLOR = COLORS.EBONY;
	
	// Light.
	var LIGHT_COLOR = exports.LIGHT_COLOR = COLORS.WHITE;
	var LIGHT_INTENSITY = exports.LIGHT_INTENSITY = 1.65;
	...
	// Fog.
	var FOG_COLOR = exports.FOG_COLOR = COLORS.BLUE;
	var FOG_DENSITY = exports.FOG_DENSITY = 0.013;
	  ...
	  _createClass(Info, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'p',
	        { className: 'info' },
	        'To move, use your left or right mouse buttons and drag it. Scroll to zoom.'
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Init = exports.Init = function Init(scene, renderer, camera, controls, light, stats) {
	  ...
	  // Light.
	  light.position.set(C.LIGHT_POSITION.X, C.LIGHT_POSITION.Y, C.LIGHT_POSITION.Z);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OnWindowResize = exports.OnWindowResize = (0, _lodash2.default)(function (camera, renderer) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var plainMaterial = function plainMaterial(model, scene) {
	...
	var uvTexture = function uvTexture(model, scene) {
	  textureLoader.load(model.t, function (texture) {
	    var material = new THREE.MeshLambertMaterial({
	      shading: THREE.FlatShading,
	      map: texture
	    });
	    ...
	    return console.log(model.t + ' ' + xhr.loaded / xhr.total * 100 + '% loaded');
	  }, function (xhr) {
	    return console.error(model.t + ' failed to load.');
	  });
	};
	
	var createMesh = function createMesh(material, model, scene) {
	  jsonLoader.load(model.g, function (geometry, materials) {
	...
	var LoadModels = exports.LoadModels = function LoadModels(scene) {
	  return _data2.default.models.map(function (model) {
	    return model.t ? uvTexture(model, scene) : plainMaterial(model, scene);
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Gui = exports.Gui = function Gui(scene, light, gui) {
	  gui = (0, _clear.clear)(gui);
	  ...
	  lightFolder.addColor(lightController, 'color', C.LIGHT_COLOR).name('Color').onChange(function (input) {
	    return (0, _updateLightColor.updateLightColor)(light, input);
	  });
	
	  lightFolder.add(lightController, 'intensity', 0, 5, 0.01).name('Intensity').onChange(function (input) {
	    return (0, _updateLight.updateLight)(light, input, 'intensity');
	  });
	
	  lightFolder.add(lightController, 'distance', 100, 500, 10).name('Distance').onChange(function (input) {
	    return (0, _updateLight.updateLight)(light, input, 'distance');
	  });
	
	  lightFolder.add(lightController, 'decay', 0, 10, 0.01).name('Decay').onChange(function (input) {
	    return (0, _updateLight.updateLight)(light, input, 'decay');
	  });
	
	  lightFolder.add(lightController, 'positionX', -80, 80, 0.1).name('x').onChange(function (input) {
	    return (0, _updateLight.updateLight)(light.position, input, 'x');
	  });
	
	  lightFolder.add(lightController, 'positionY', 10, 80, 0.1).name('y').onChange(function (input) {
	    return (0, _updateLight.updateLight)(light.position, input, 'y');
	  });
	
	  lightFolder.add(lightController, 'positionZ', -30, 80, 0.1).name('z').onChange(function (input) {
...
/***/ function(module, exports) {
	...
	var clear = exports.clear = function clear(gui) {
	  if (gui) {
	    gui.destroy();
	  }
...
/***/ function(module, exports) {
	...
	var updateLightColor = exports.updateLightColor = function updateLightColor(light, input) {
...
/***/ function(module, exports) {
	...
	var updateLight = exports.updateLight = function updateLight(light, input, property) {
...
/***/ function(module, exports) {
	...
	var WebglSupport = exports.WebglSupport = function WebglSupport() {
	  if (!Detector.webgl) {
