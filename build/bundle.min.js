...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateLightIntensity = function updateLightIntensity() {
	  light.intensity = lightController.intensity;
	};
	
	var updateLightDistance = function updateLightDistance() {
	  light.distance = lightController.distance;
	};
	
	var updateLightDecay = function updateLightDecay() {
	  light.decay = lightController.decay;
	};
	
	var updateLightPosition = function updateLightPosition() {
	  light.position.set(lightController.positionX, lightController.positionY, lightController.positionZ);
	};
